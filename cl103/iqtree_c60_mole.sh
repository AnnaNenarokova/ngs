#!/bin/bash
#SBATCH --job-name=iqtree_LG_C60
#SBATCH --output=/home/users/nenarokova/slurm_output/iqtree_LG_C60_UFB_%A.out
...
cd $workdir
iqtree2 -s "$msa" -T 8 -m LG+C60+G -B 1000 -mem 250G -redo -pre LG_C60_G